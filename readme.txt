...
Installing "TW_Team_Plugin" can be done either by searching for "TW_Team_Plugin" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
